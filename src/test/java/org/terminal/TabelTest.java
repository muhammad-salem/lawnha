...
public class TabelTest {
	...
	public void testAnsi() throws Exception {
		...
		Cell<String> cell = new Cell<String>(4, 5, 
				getRandomString() + '\n' + getRandomString() + '\n' + getRandomString());
		row.add(cell);
		System.out.println(row.toString(TableThemes.DEFAULT_THEME, headStyle, borderStyle, RowPosition.TABLE));
